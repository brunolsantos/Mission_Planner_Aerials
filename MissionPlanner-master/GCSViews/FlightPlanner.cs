...
namespace MissionPlanner.GCSViews
{
    public partial class FlightPlanner : MyUserControl, IDeactivate, IActivate
    {
        ...
        public Button ButtonSurvey { get { return BUT_Survey; } } //MB_270414 Huge thanks to Mathew Wright from Event38
        ...
        public FlightPlanner()
        {
            ...
            //CMB_altmode.Items.Remove(altmode.Absolute.ToString());
        ...
        public void removeContextMenuItems()
        {
            ...
            contextMenuStrip1.Items[19].Visible = false;
            contextMenuStrip1.Items[20].Visible = false;
            contextMenuStrip1.Items[21].Visible = false;
            contextMenuStrip1.Items[22].Visible = false;
        ...
        void updateCMDParams()
        {
            ...
            foreach (string item in cmdParamNames.Keys)
            {
                ...
                else if (item == "VTOL_LAND")
                {
                    cmds.Add(item);
                }
                else if (item == "VTOL_TAKEOFF")
                {
                    cmds.Add(item);
                }
                else if (item == "DO_VTOL_TRANSITION")
                {
                    cmds.Add(item);
                }
                else if (item == "DO_SET_CAM_TRIGG_DIST")
                {
                    cmds.Add(item);
                }
                else if (item == "DO_CHANGE_SPEED")
                {
                   cmds.Add(item);
                }
                else if (item == "DO_SET_SERVO")
                {
                   cmds.Add(item);
                }
                else if (item == "DO_PARACHUTE")
                {
                   cmds.Add(item);
                }
                else if (item == "AUTO")
        ...
        */
            ...
            double y, double z)
        {
            ...
            //else if (cmd == MAVLink.MAV_CMD.DO_SET_SERVO)
            //{
            //    Commands.Rows[rowIndex].Cells[Param1.Index].Value = 10;
            //    Commands.Rows[rowIndex].Cells[Param2.Index].Value = 1000;
...
Column 1: Field type (RALLY is the only one at the moment -- may have RALLY_LAND in the future)
 ...
 Column 7: Flags (just 0 for now, also future use).
        ...
        private void flightDataToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void BUT_AddPolygon_Click(object sender, EventArgs e)
        {
            if (polygongridmode == false)
            {
        ...
        private void BUT_ClearPolygon_Click(object sender, EventArgs e)
        {
