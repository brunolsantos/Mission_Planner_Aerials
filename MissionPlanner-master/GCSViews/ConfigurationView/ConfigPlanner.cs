...
namespace MissionPlanner.GCSViews.ConfigurationView
{
    public partial class ConfigPlanner : UserControl, IActivate
    {
        ...
        private void btnSetMJPEGUrl_Click(object sender, EventArgs e)
        {
            // string url = MainV2.config["mjpeg_url"] != null ? MainV2.config["mjpeg_url"].ToString() : @"http://127.0.0.1:56781/map.jpg";//@urlVideo;//@"http://127.0.0.1:56781/map.jpg";
            //--string url = CaptureMJPEG.URL;
            //--if (DialogResult.OK == InputBox.Show("Mjpeg url", "Enter the url to the mjpeg source url", ref url, false))
            //try
            //--{
