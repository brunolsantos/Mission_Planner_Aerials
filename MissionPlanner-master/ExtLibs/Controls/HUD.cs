...
namespace MissionPlanner.Controls
{
    public class HUD : GLControl
    {
        ...
        private readonly Pen _greenPen = new Pen(Color.DarkBlue,4);
                ...
                if (bgon == true)
                {
                    ...
                    if (bg.Height != 0)
                    {
                        using (
                            ...
                            LinearGradientBrush linearBrush = new LinearGradientBrush(
                                bg, Color.FromArgb(60, 60, 255), Color.LightBlue, LinearGradientMode.Vertical))
                        {
                    ...
                    if (bg.Height != 0)
                    {
                        using (
                            ...
                            LinearGradientBrush linearBrush = new LinearGradientBrush(
                                bg, Color.FromArgb(255, 173, 8),Color.FromArgb(65, 43, 0), LinearGradientMode.Vertical))
                        {
                            graphicsObject.FillRectangle(linearBrush, bg);
                        }
                    }
