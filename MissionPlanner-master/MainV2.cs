...
namespace MissionPlanner
{
    public partial class MainV2 : Form
    {
        ...
        setPassword setPass = setPassword.Instance;
        ...
        //"atalho para trocar a imagem do botão RTL"
        public void callRtlChangeButton()
        {
            FlightData.setRtlWhiteButton();
        }
        ...
        public MainV2()
        {
            ...
            InitializeComponent();
            panel1Height = panel1.Height - 1;//Modificados depois
        ...
        public void enableConfigTunning()
        {
            MenuConfigTune.Enabled = true;
            MenuConfigTune.Visible = true;
        }
        ...
        public void fullScreenToolStripMenuItem_doClick()
        {
            if (fullscreen == false)
            {
                this.TopMost = false;
        ...
        public void setMenuEnable()
        {
            if (connectMenu == true)
            {
                ...
                panel1.Location = new Point(this.Size.Width - 465, 33);
                //panel1.Width = menu.Width;
                panel1.Width = 310;
        ...
        public void MenuInitConfig_doClick()
        {
            MenuInitConfig.PerformClick();
        }
        public void MenuConfigTune_doClick()
        {
            MenuConfigTune.PerformClick();
        }
        public void MenuFlightPlanner_doClick()
        {
            MenuFlightPlanner.PerformClick();
        }
        public void MenuFlightData_doClick()
        {
